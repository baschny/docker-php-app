...
echo "application:$PASS" | chpasswd

# Make sure 'application' home directory exists...
mkdir -p /home/application && chown application /home/application
...
env | egrep -v '^(PATH|HOME|PWD|USER|SHELL|HOSTNAME|LOGNAME)' >> /etc/environment
